...
<div class="acontainer clearfix">		
		<div class="content">
			<div class="top">
				<div class="left"><h1><?php echo ot_get_option( 'aboutus_mission_heading' );?></h1><p><?php echo ot_get_option( 'aboutus_mission_sub_heading' );?></p></div>
				<div class="right"><h1><?php echo ot_get_option( 'aboutus_vision_heading' );?></h1><p><?php echo ot_get_option( 'aboutus_vision_sub_heading' );?></p></div>		
			</div>
			<div class="bottom">
